class MarketingModal {
  String? libraryCategoryTitle;
  List<VideoLibraries>? videoLibraries;

  MarketingModal({this.libraryCategoryTitle, this.videoLibraries});

  MarketingModal.fromJson(Map<String, dynamic> json) {
    this.libraryCategoryTitle = json["library_category_title"];
  ...
  Map<String, dynamic> toJson() {
    ...
    data["library_category_title"] = this.libraryCategoryTitle;
